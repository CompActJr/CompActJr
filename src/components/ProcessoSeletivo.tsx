                    ...
                    <div className="ps-edital-grid">
                        {[
                            ...
                            },
                            {
                                icon: <IconRequisitos />,
                                title: 'Requisitos',
                                text: 'Podem se inscrever estudantes regularmente matriculados em qualquer curso de graduação da Universidade Federal de Santa Maria (UFSM), campus Santa Maria. ',
                            },
                            {
                                icon: <IconCalendario />,
                                title: 'Cronograma',
